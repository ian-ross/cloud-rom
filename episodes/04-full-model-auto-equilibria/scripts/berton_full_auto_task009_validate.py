...
The script compiles a small Fortran driver against episodes/04-full-model-auto-equilibria/auto/berton_full/bertonfull.f90,
...
AUTO_DIR = EPISODE_ROOT / "auto" / "berton_full"
