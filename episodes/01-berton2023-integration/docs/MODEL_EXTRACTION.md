...
- **Extraction notes:** `pandoc` is installed, but cannot read PDF input (`Unknown input format pdf`). Text was therefore extracted with `pdftotext` into:
  - `references/berton-2023-pdftotext.txt` (`-layout`, best for equations/tables)
  - `references/berton-2023-raw.txt` (`-raw`, fallback for prose)
...
- `episodes/01-berton2023-integration/examples/berton2023_case0.py` — minimal short Case 0 run.
- `episodes/01-berton2023-integration/notebooks/atmospheric-profiles.ipynb` — reproduces paper Figures 1--5.
- `episodes/01-berton2023-integration/notebooks/replicate-steady-state.ipynb` — steady/non-oscillatory Case 0 reproduction workflow.
- `episodes/01-berton2023-integration/notebooks/replicate-oscillatory-state.ipynb` — oscillatory Case 0 reproduction workflow.
- `episodes/01-berton2023-integration/docs/MODEL_EXTRACTION.md` — this extraction/implementation record.
- `episodes/01-berton2023-integration/docs/berton2023-model-code.md` — code guide for humans and agents.
- `episodes/01-berton2023-integration/docs/notebooks.md` — notebook guide.
...
- `episodes/01-berton2023-integration/examples/berton2023_case0.py`: short Case 0 run that prints final state diagnostics.
- `episodes/01-berton2023-integration/notebooks/atmospheric-profiles.ipynb`: reproduces Figures 1--5 atmospheric profiles.
- `episodes/01-berton2023-integration/notebooks/replicate-steady-state.ipynb`: runs and plots the steady/non-oscillatory Case 0 state.
- `episodes/01-berton2023-integration/notebooks/replicate-oscillatory-state.ipynb`: runs and plots the oscillatory Case 0 state.
