!----------------------------------------------------------------------
! TASK-016 full Berton (2023) four-state scaled equilibrium problem for AUTO-07p.
!
! AUTO variables are arclength-scaled around the TASK-011/TASK-012 seed:
! U(1)=Z=(z-z_seed)/1000, U(2)=U_h=(u-u_seed)/5,
! U(3)=W=w/1, U(4)=P=(log(m/m_seed))/10.
! Physical inverse: z=z_seed+1000*Z, u=u_seed+5*U_h,
! w=W, m=m_seed*exp(10P). The active control is
! PAR(96)=q_H=(H_a3-0.61)/0.001; PAR(4) is populated in PVLS for reporting.
...
CONTAINS
  ...
  SUBROUTINE scaled_to_physical(us,par,uphys,workpar)
    ...
    DOUBLE PRECISION, INTENT(OUT) :: uphys(4), workpar(96)
    workpar(1:95)=par(1:95)
    workpar(96)=par(96)
    workpar(4)=0.61D0 + 0.001D0*par(96)
  ...
  SUBROUTINE rhs_scaled(us,par,fscaled)
    ...
    DOUBLE PRECISION :: uphys(4), workpar(96), fphys(4)
...
SUBROUTINE STPNT(NDIM,U,PAR,T)
  ...
  ! z_W0=9000 m, W_a0=0.6 m/s, H_a3=0.61, include_coriolis=0.
  PAR(1)=9000D0
  PAR(2)=0.6D0
  PAR(4)=0.61D0
  PAR(39)=0D0
...
SUBROUTINE PVLS(NDIM,U,PAR)
  ...
  DOUBLE PRECISION, INTENT(INOUT) :: PAR(*)
  DOUBLE PRECISION :: us(4), uphys(4), workpar(96), fscaled(4)
  us(1:4)=U(1:4)
  CALL scaled_to_physical(us,PAR,uphys,workpar)
  PAR(4)=workpar(4)
  PAR(54)=PAR(96)
