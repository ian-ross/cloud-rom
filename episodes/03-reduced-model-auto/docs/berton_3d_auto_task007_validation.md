...
- `episodes/03-reduced-model-auto/auto/berton_reduced_3d/berton3d.f90`
- `episodes/03-reduced-model-auto/auto/berton_reduced_3d/c.berton3d.k`
- `episodes/03-reduced-model-auto/auto/berton_reduced_3d/c.berton3d.alpha`
- `episodes/03-reduced-model-auto/auto/berton_reduced_3d/run_auto.sh`

The validation/cross-check script and reproducibility notebook are:

- `episodes/03-reduced-model-auto/scripts/berton_3d_auto_task007_validate.py`
- `episodes/03-reduced-model-auto/notebooks/berton_3d_auto_task007_validation.ipynb`
...
# jupyter notebook episodes/03-reduced-model-auto/notebooks/berton_3d_auto_task007_validation.ipynb
```

The run script saves these AUTO files, which were inspected by the validation script:

```text
episodes/03-reduced-model-auto/auto/berton_reduced_3d/b.bert3d-k
episodes/03-reduced-model-auto/auto/berton_reduced_3d/s.bert3d-k
episodes/03-reduced-model-auto/auto/berton_reduced_3d/d.bert3d-k
episodes/03-reduced-model-auto/auto/berton_reduced_3d/b.bert3d-alpha
episodes/03-reduced-model-auto/auto/berton_reduced_3d/s.bert3d-alpha
episodes/03-reduced-model-auto/auto/berton_reduced_3d/d.bert3d-alpha
```
...
- No numerical discrepancies were found at the tolerances in `episodes/03-reduced-model-auto/scripts/berton_3d_auto_task007_validate.py`; AUTO `a0` and `a2*a1-a0` match the Python corrected cubic at parsed branch points.
