...
!----------------------------------------------------------------------
! TASK-021 minimal restricted/scaled 3D equilibrium gate.
!
...
SUBROUTINE FUNC(NDIM,U,ICP,PAR,IJAC,F,DFDU,DFDP)
  ...
  ! TASK-021 intentionally supplies no analytic/user Jacobian.  The first
  ! diagnostic run uses JAC=0 so AUTO finite-differences this residual.
...
SUBROUTINE PVLS(NDIM,U,PAR)
  ...
  DOUBLE PRECISION, INTENT(INOUT) :: PAR(*)
  ! Deliberately empty: TASK-021 strips PVLS diagnostic bookkeeping.
END SUBROUTINE PVLS
