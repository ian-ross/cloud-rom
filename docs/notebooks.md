...
## `notebooks/atmospheric-profiles.ipynb`
...
## `notebooks/replicate-steady-state.ipynb`
...
## `notebooks/replicate-oscillatory-state.ipynb`
...
- `notebooks/df_steady_magnitudes.csv`
- `notebooks/df_oscillatory_magnitudes.csv`
