...
This script parses the saved AUTO-07p output from ``auto/berton_full``,
...
Outputs are written under ``outputs/task010/``.
"""
...
from berton_full_auto_task009_validate import AUTO_DIR, REPO_ROOT, finite_difference_jacobian, python_rhs

B_FILE = AUTO_DIR / "b.bertfull-zW0"
S_FILE = AUTO_DIR / "s.bertfull-zW0"
D_FILE = AUTO_DIR / "d.bertfull-zW0"
OUT_DIR = REPO_ROOT / "outputs" / "task010"
